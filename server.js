...
// Trust Render proxy (Secure/SameSite=None cookies)
...
// 🔑 Root redirect: when Shopify opens your app at "/", go to embedded UI
app.get("/", (req, res) => {
...
// Embedded page: inject API key at runtime
app.get("/embedded", (_req, res) => {
  ...
  fs.readFile(filePath, "utf8", (err, html) => {
    ...
    const injected = html.replace("%SHOPIFY_API_KEY%", String(process.env.SHOPIFY_API_KEY || ""));
